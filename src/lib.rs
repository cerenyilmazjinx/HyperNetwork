...
#[derive(Debug)]
pub struct HyperNetworkProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HyperNetworkProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HyperNetwork processing");
    
    let mut processor = HyperNetworkProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HyperNetworkProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HyperNetworkProcessor::new(false);
